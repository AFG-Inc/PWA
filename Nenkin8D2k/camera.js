...
//loadText('https://afg-inc.github.io/PWA/Nenkin8D2k/KanjiList.str', 'Kanji');
loadText('https://afg-inc.github.io/PWA/Nenkin8D2k/Teikibin2.htm', 'text');
//loadText('Teikibin2.htm', 'text');

for (let i=0; i<FontCount; i++){
    //loadData(i+'.dat', i);
    loadData('https://afg-inc.github.io/PWA/Nenkin8D2k/' + i + '.dat', i);
}
...
function setPaper() {
    ...
    // }
    // if (paperNum == 1) {
    //     loadText('https://afg-inc.github.io/PWA/Nenkin8D2k/Teikibin1.htm', 'text');
    //     paper.value = "用紙 1";
    ...
    // } else {
    //     loadText('https://afg-inc.github.io/PWA/Nenkin8D2k/Teikibin3.htm', 'text');
    //     paper.value = "用紙 3";
...
function openCamera() {
    ...
    constraints = { audio: false, video: { facingMode: 'environment', width: 1920, height: 1080 } };
    //}
